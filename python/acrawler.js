...
(glb = "undefined" == typeof window ? global : window)._$jsvmprt = function(b, e, f) {
    ...
    function K(b, e, f, a, d, c, n, i) {
        ...
        for (t = 0,
            ...
            o[t] = a[t];
        var r1 = i && !B[e] && F(b, e, 2 * f),
            r2 =B[e] ? G(b, e, f, 0, o, c, null, 1)[1] : G(b, e, f, 0, o, c, null, 0)[1]
        // ktime++;
        return r1,r2;
    }
},
    ...
    var urls = "https://www.douyin.com/aweme/v1/web/comment/list/?device_platform=webapp&aid=6383&channel=channel_pc_web&aweme_id=6974719385269243143&version_code=160100&version_name=16.1.0&cursor=0&count=20";
    var signature = window.byted_acrawler.sign({url:urls});

// var signature = window.byted_acrawler.sign(["GET","/aweme/v1/web/search/item/?device_platform=webapp&aid=6383&channel=channel_pc_web&search_channel=aweme_video_web&sort_type=1&publish_time=0&keyword=77777777777ge&search_source=normal_search&query_correct_type=1&is_filter_search=1&offset=0&count=24&version_code=160100&version_name=16.1.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+WOW64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F55.0.2883.87+UBrowser%2F6.2.3964.2+Safari%2F537.36&browser_online=true",true]);
// var signature = window.byted_acrawler.sign([{"events":[{"event":"search_filter_show","params":"{\"impr_id\":\"\",\"search_id\":\"\",\"search_keyword\":\"\",\"search_type\":\"aweme_video_web\",\"event_index\":1625818144406}","local_time_ms":1625817510241,"is_bav":0,"ab_sdk_version":"","session_id":"a47c474e-30b5-422e-9785-40a11c17929c"},{"event":"predefine_pageview","params":"{\"title\":\"发现更多精彩视频 - 抖音视频搜索\",\"url\":\"https://www.douyin.com/search/77777777777ge?publish_time=0&sort_type=1&source=normal_search&type=video\",\"url_path\":\"/search/77777777777ge\",\"time\":1625817510181,\"referrer\":\"\",\"$is_first_time\":\"false\",\"event_index\":1625818144405}","local_time_ms":1625817510181,"is_bav":0,"ab_sdk_version":"","session_id":"a47c474e-30b5-422e-9785-40a11c17929c"}],"user":{"user_unique_id":"6982149487444903431","web_id":"6981469193178924579","ssid":"81d7bbff-bb46-44df-8ed3-6f22c41930ba"},"header":{"app_id":6383,"os_name":"windows","os_version":"10","device_model":"Windows NT 10.0","language":"zh-CN","platform":"web","sdk_version":"4.1.53_2","sdk_lib":"js","timezone":8,"tz_offset":-28800,"resolution":"1920x1080","browser":"Chrome","browser_version":"55.0.2883.87","referrer":"","referrer_host":"","width":1920,"height":1080,"screen_width":1920,"screen_height":1080,"custom":"{}"},"local_time":1625817510}]);

// "/aweme/v1/web/search/item/?device_platform=webapp&aid=6383&channel=channel_pc_web&search_channel=aweme_video_web&sort_type=1&publish_time=0&keyword=77777777777ge&search_source=normal_search&query_correct_type=1&is_filter_search=1&offset=0&count=24&version_code=160100&version_name=16.1.0&cookie_enabled=true&screen_width=1920&screen_height=1080&browser_language=zh-CN&browser_platform=Win32&browser_name=Mozilla&browser_version=5.0+(Windows+NT+10.0%3B+WOW64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F55.0.2883.87+UBrowser%2F6.2.3964.2+Safari%2F537.36&browser_online=true"

// "nonceStr":"aid=6383&browser_language=zh-CN&browser_name=Mozilla&browser_online=true&browser_platform=Win32&browser_version=5.0+(Windows+NT+10.0%3B+WOW64)+AppleWebKit%2F537.36+(KHTML,+like+Gecko)+Chrome%2F55.0.2883.87+UBrowser%2F6.2.3964.2+Safari%2F537.36&channel=channel_pc_web&cookie_enabled=true&count=24&device_platform=webapp&is_filter_search=1&keyword=77777777777ge&offset=0&publish_time=0&query_correct_type=1&screen_height=1080&screen_width=1920&search_channel=aweme_video_web&search_source=normal_search&sort_type=1&version_code=160100&version_name=16.1.0&pathname=/aweme/v1/web/search/item/&tt_webid=&uuid="
