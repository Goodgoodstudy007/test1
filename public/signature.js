...
function writeOut(output) {
    fs.appendFile('output.log', output, 'utf8', (err) => {
      if (err) {
...
function search_item(keyword,count,offset,sort_type,publish_time){
        var e={"url":"/aweme/v1/web/search/item/","method":"get","headers":{"Accept":"application/json, text/plain, */*","Content-Type":"application/json","withCredentials":true},"params":{"device_platform":"webapp","aid":6383,"channel":"channel_pc_web","search_channel":"aweme_video_web","sort_type":sort_type,"publish_time":publish_time,"keyword":keyword,"search_source":"normal_search","query_correct_type":1,"is_filter_search":1,"offset":offset,"count":count,"version_code":"170400","version_name":"17.4.0","cookie_enabled":true,"screen_width":1280,"screen_height":720,"browser_language":"zh-CN","browser_platform":"Win32","browser_name":"Mozilla","browser_version":"5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.164 Safari/537.36","browser_online":true},"baseURL":"","transformRequest":[null],"transformResponse":[null],"timeout":0,"xsrfCookieName":"XSRF-TOKEN","xsrfHeaderName":"X-XSRF-TOKEN","maxContentLength":-1,"maxBodyLength":-1};
        var f = e.data
          , d = e.headers;
        r.isFormData(f) && delete d["Content-Type"];
        var h = new XMLHttpRequest;
        ...
        var v = e.url;
        writeOut(JSON.stringify(e.paramsSerializer) + "\n");
        if (h.open(e.method.toUpperCase(), a(v, e.params, e.paramsSerializer), !0),
        h.timeout = e.timeout,
        h.onreadystatechange = function() {
            if (h && 4 === h.readyState && (0 !== h.status || h.responseURL && 0 === h.responseURL.indexOf("file:"))) {
        ...
        f || (f = null),
        h.send(f);
        console.log('h._url=',h._url);
        return "https://www.douyin.com" + h._url

}

function comment(aweme_id,offset,count){
        var e={
...
function follow(token){
        var e={
            "url":"/aweme/v1/web/commit/follow/user/",
            "method":"post",
            "headers":{
                        "Accept":"application/json, text/plain, */*",
            ...
            "params":{
                ...
                "version_code":"170400",
                "version_name":"17.4.0",
                "cookie_enabled":true,"screen_width":1536,
                "screen_height":864,"browser_language":"zh-CN",
                "browser_platform":"Win32","browser_name":"Mozilla",
                "browser_version":"5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/86.0.4240.198 Safari/537.36",
                "browser_online":true
            },
            "data":{
                "type" : 1,
...
function aweme_post(sec_user_id,count,max_cursor){
        var e={
...
function user_profile(sec_user_id){
        var e={
