<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"/www/wwwroot/douyin_xunpang/public/../application/store/view/user/login.html";i:1626919368;}*/ ?>
        ...
        <script>
            $(function() {
                $('.btn-login').on('click', function() {
                    ...
                    $.post("/store/user/login_post", form, function(ret) {
                        if (ret.code == 0) {
