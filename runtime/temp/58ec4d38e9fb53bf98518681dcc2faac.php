<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/www/wwwroot/douyin_xunpang/public/../application/agent/view/store/agent_list.html";i:1629907168;s:62:"/www/wwwroot/douyin_xunpang/application/agent/view/footer.html";i:1627542144;}*/ ?>
        ...
        <div class="huyong">
            ...
            <div class="bottmo" id="list<?php echo $v['id']; ?>">
                <div class="liebiao">
                    <div class="lie_top">
                        <div class="names">
                            <?php echo $v['agent_name']; ?>                        
                        </div>
                    </div>
                    <div class="add_miss">
                        <div class="surplus" style="width:100%;">
                            已开商家：<span><?php echo $v['store_sum']; ?> 家</span>
                    ...
                    <div class="rise" id="info_45" >
                        <div class="lie_there">
                            <div class="money_sol">
                                点数：<span><?php echo $v['dianshu']; ?>点</span>
                            </div>
                            <div class="money_sol">
                                商家上限：<span><?php echo $v['store_count']; ?>家</span>
                            </div>
                            <div class="money_sol">
                                佣金比例：<span><?php echo $v['rate']; ?>%</span>
                            </div>
                        </div>
                        <div class="lie_four">
                            <a class="four_one" href="/agent/store/edit_agent?agent_id=<?php echo $v['id']; ?>"><span>编辑</span></a>
                            <a class="four_two" href="javascript:void(0)" onclick="pay_agent(<?php echo $v['id']; ?>)" style="background: orange;"><span>充值</span></a>
                            <a class="four_two" href="javascript:void(0)" onclick="delete_agent(<?php echo $v['id']; ?>)" style="background: #9c9c9c;"><span>删除</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function pay_agent(agent_id){
        layer.prompt({
                ...
                $.ajax({
                    type:"post",
                    data:{"dianshu":value,'agent_id':agent_id},
                    url:"/agent/store/pay_agent",
                    datatype:"json",
    ...
    function delete_agent(id) {
        ...
        mui.confirm('删除代理后数据不可恢复，你确定要删除吗？', '删除提示', btnArray, function (e) {
            if (e.index == 0 && !run_confim) {
                run_confim = true;
                $.get("/agent/store/delete_agent",{"agent_id": id},function (data) {
                    if (data.code == 0) {   
