...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-store_name" data-rule="required" class="form-control" name="row[store_name]" type="text" value="<?php echo htmlentities($row['store_name']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-3"><?php echo __('Agent_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-agent_id" data-rule="required"  class="form-control" name="row[agent_id]" type="text" value="<?php echo htmlentities($row['agent_id']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-task_count" class="form-control"  name="row[task_count]" type="number" value="<?php echo $row['task_count']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-dy_count" class="form-control"  name="row[dy_count]" type="number" value="<?php echo $row['dy_count']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-xhs_count" class="form-control"  name="row[xhs_count]" type="number" value="<?php echo $row['xhs_count']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label>
                    <input type="radio" name="row[is_repeat]" class="is_repeat" <?php if($row['is_repeat']==0): ?>checked<?php endif; ?> value="0">重复采集
                </label>
                <label>
                    <input type="radio" name="row[is_repeat]" class="is_repeat" <?php if($row['is_repeat']==1): ?>checked<?php endif; ?> value="1">去重采集
                </label>
            </div>
