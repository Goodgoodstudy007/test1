...
<form id="add-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <p style="margin-top:5px;color:#888;">筛选K手全网关键词，例如：广州周边游 </p>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2">时间筛选:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="radio">
                <label>
                    <input type="radio" name="row[public_time]" checked value="0">全部
                </label>
                <label>
                    <input type="radio" name="row[public_time]"  value="15">15天内
                </label>
                <label>
                    <input type="radio" name="row[public_time]" value="30">一个月内
                </label>
                <label>
                    <input type="radio" name="row[public_time]" value="180">半年内
                </label>
                <label>
                    <input type="radio" name="row[public_time]" value="365">一年内
                </label>
            </div>
        </div>
    </div>
