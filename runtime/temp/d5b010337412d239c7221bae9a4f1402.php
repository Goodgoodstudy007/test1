            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover"
                           data-operate-edit="<?php echo $auth->check('video_comment/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('video_comment/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
...
<div class="qrcode-popul" style="display: none;">
    <div class="qrcode-populBox">
        <h6 class="qrcode-title">抖音扫码私信</h6>
